...
def make_predictions(model, imagePath):
    ...
    with torch.no_grad():
        ...
        predMask = torch.softmax(predMask, dim=0)
        ...
        # red
        color_mask[(predMask[1] > 0.25) * (predMask[1] > predMask[2]), 1] = 255
        color_mask[(predMask[1] > 0.25) * (predMask[1] > predMask[2]), 0] = 0
        color_mask[(predMask[1] > 0.25) * (predMask[1] > predMask[2]), 0] = 0
        # green
        color_mask[(predMask[2] > 0.25) * (predMask[2] > predMask[1]), 0] = 0
        color_mask[(predMask[2] > 0.25) * (predMask[2] > predMask[1]), 1] = 255
        color_mask[(predMask[2] > 0.25) * (predMask[2] > predMask[1]), 2] = 0
